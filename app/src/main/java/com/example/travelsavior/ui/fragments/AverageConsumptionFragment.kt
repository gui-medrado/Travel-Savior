...
import com.example.travelsavior.databinding.FragmentAverageConsumptionBinding
...
class AverageConsumptionFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val editText = binding.fragAvarageEditText

        editText.addTextChangedListener {
            viewModel.setAverageConsumption(it.toString().toDoubleOrNull() ?: 0.0)
        }
    }
